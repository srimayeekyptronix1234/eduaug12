...
class Admin extends CI_Controller {
  ...
  function download_file($path, $name)
  {
	...
	public function vehicle($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
			$page_data['page_form']=$param1;
			$this->load->view('backend/admin/vehicle/list', $page_data);
		}
	...
	public function assignvehicle($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
			$page_data['page_form']=$param1;
			$this->load->view('backend/admin/assignvehicle/list', $page_data);
		}
	...
	public function candidate_list($param1 = '', $param2 = '', $param3 = ''){
		...
		if ($param1 == 'list') {
			$this->load->view('backend/admin/candidate_list/list');
		}
	...
	public function users_list($param1 = '', $param2 = '', $param3 = ''){
		...
		if($param1 == 'update'){
			$response = $this->user_model->update_users($param2);
			echo $response;
		}

		if($param1 == 'delete'){
			$response = $this->user_model->delete_users($param2);
			echo $response;
		}

		if ($param1 == 'list') {
			$this->load->view('backend/admin/users_list/list');
		}

		if(empty($param1)){
			$page_data['folder_name'] = 'users_list';
			$page_data['page_title'] = 'users_list';
			$this->load->view('backend/index', $page_data);
		}
	}
	...
	public function staff_attendance($param1 = '', $param2 = '', $param3 = ''){
		...
		if($param1 == 'take_attendance'){
			$response = $this->crud_model->take_staff_attendance();
			echo $response;
		}
		...
		if($param1 == 'staff'){
			$page_data['attendance_date'] = strtotime($this->input->post('date'));
			$page_data['staff_role'] = htmlspecialchars($this->input->post('role'));
			$this->load->view('backend/admin/staff_attendance/staff', $page_data);
		}
  ...
  //Classroom Walkthrough Section Start
	...
	public function assignment_list($param1 = '', $param2 = '', $param3 = ''){
		...
		if ($param1 == 'list') {
			$this->load->view('backend/admin/assignment_list/list');
		}
