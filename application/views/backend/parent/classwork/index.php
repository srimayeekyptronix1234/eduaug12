        ...
        <div class="card parentbar">
            <div class="card-body py-2 d-flex flex-column">
                <h4 class="page-title d-inline-block">
                    ...
                    <span class="ms-2"><?php echo get_phrase('manage_classwork_marks'); ?></span>
                </h4>
                <p class="inspiring-line">
                    Track progress meticulously to foster academic excellence.
                </p>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    <button class="btn btn-block btn-secondary filbtn"
                        onclick="filter_classwork_marks()"><?php echo get_phrase('filter'); ?></button>
                </div>
            </div>
            <div class="card-body classwork_content">
...
<script>
    ...
    function filter_classwork_marks() {
