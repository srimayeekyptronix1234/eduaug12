        ...
        <div class="card parentbar">
            <div class="card-body py-2 d-flex flex-column">
                <h4 class="page-title d-inline-block">
                    ...
                    <span class="ms-2"><?php echo get_phrase('manage_project_marks'); ?></span>
                </h4>
                <p class="inspiring-line">
                    Empower your projects with precise assessments for exceptional results.
                </p>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    <button class="btn btn-block btn-secondary filbtn"
                        onclick="filter_project_marks()"><?php echo get_phrase('filter'); ?></button>
                </div>
            </div>
...
<script>
    ...
    function filter_project_marks() {
        ...
        if (exam_id != "" && class_id != "" && section_id != "" && subject_id != "") {
            $.ajax({
                type: 'POST',
                url: '<?php echo route('project/list') ?>',
