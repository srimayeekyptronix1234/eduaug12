            ...
            <div class="card-body d-flex flex-column py-2">
                <div>
                    <h4 class="page-title mb-0 d-flex align-items-center">
                        <i class="mdi mdi-chart-timeline title_icon" style="font-size: 1.5rem; color: #ff7580;"></i>
                        <span
                    ...
                    <p class="text-muted mt-2" style="font-size: 16px; font-weight: 600; color: #2c2c2c;">
                        Review and update the syllabus for each class.
                    </p>
                </div>
            </div> <!-- end card body-->
        </div> <!-- end card -->
                    ...
                    <div class="col-md-4 mb-1">
                        <select name="student_id" id="student_id" name="student_id" class="form-control select2"
                            ...
                            <?php foreach ($student_lists as $student_list): ?>
                                <option value="<?php echo $student_list['id']; ?>"><?php echo $student_list['name']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
