            ...
            <div class="dropdown text-center">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="javascript:void(0);" class="dropdown-item"
                  onclick="rightModal('<?php echo site_url('modal/popup/complaintsactions/edit/' . $data['id']) ?>', '<?php echo get_phrase('update_Complaint'); ?>');"><?php echo get_phrase('edit'); ?></a>
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item"
                  onclick="confirmModal('<?php echo route('complaintsactions/delete/' . $data['id']); ?>', showAllComplaint)"><?php echo get_phrase('delete'); ?></a>
                <a href="javascript:void(0);" class="dropdown-item"
