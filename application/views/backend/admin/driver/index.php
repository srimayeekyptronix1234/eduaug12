            ...
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="page-title d-flex align-items-center">
                        ...
                        <span class="ms-2"><?php echo get_phrase('driver'); ?></span>
                    </h4>
                    <p class="inspiring-line mt-2">
                        Driving us forward with safety and reliability.
                    </p>
                </div>
                <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1"
                    onclick="rightModal('<?php echo site_url('modal/popup/driver/create'); ?>', '<?php echo get_phrase('add_driver'); ?>')">
                    <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_driver'); ?>
                </button>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
