            ...
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="page-title d-flex align-items-center">
                        ...
                        <span class="ms-2"><?php echo get_phrase('librarian'); ?></span>
                    </h4>
                    <p class="inspiring-line mt-2">
                        Guardians of knowledge, guiding students to a world of learning.
                    </p>
                </div>
                <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1"
                    onclick="rightModal('<?php echo site_url('modal/popup/librarian/create'); ?>', '<?php echo get_phrase('create_librarian'); ?>')">
                    <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_librarian'); ?>
                </button>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
