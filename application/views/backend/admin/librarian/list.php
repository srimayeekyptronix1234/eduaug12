						...
						<div class="dropdown text-center">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="rightModal('<?php echo site_url('modal/popup/librarian/edit/' . $user['id']) ?>', '<?php echo get_phrase('update_librarian'); ?>');"><?php echo get_phrase('edit'); ?></a>
								<!-- item-->
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="confirmModal('<?php echo route('librarian/delete/' . $user['id']); ?>', showAllLibrarians )"><?php echo get_phrase('delete'); ?></a>
							</div>
						</div>
					</td>
				</tr>
