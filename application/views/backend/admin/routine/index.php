			...
			<div class="card-body py-2 d-flex justify-content-between align-items-center">
				<div>
					...
					<p class="inspiring-line">
						A well-planned routine is the foundation of excellence.
					</p>
				</div>
				<button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1"
					onclick="rightModal('<?php echo site_url('modal/popup/routine/create'); ?>', '<?php echo get_phrase('create_routine'); ?>')">
					<i class="mdi mdi-plus"></i> <?php echo get_phrase('add_class_routine'); ?>
				</button>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
