            ...
            <div class="dropdown text-center">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="javascript:void(0);" class="dropdown-item"
                  onclick="rightModal('<?php echo site_url('modal/popup/vehicle/edit/' . $data['id']) ?>', '<?php echo get_phrase('update_vehicle'); ?>');"><?php echo get_phrase('edit'); ?></a>
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item"
                  onclick="confirmModal('<?php echo route('vehicle/delete/' . $data['id']); ?>', showAllVehicle)"><?php echo get_phrase('delete'); ?></a>
