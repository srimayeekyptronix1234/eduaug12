      ...
      <div class="card-body py-2 d-flex justify-content-between align-items-center">
        <div>
          <h4 class="page-title d-flex align-items-center">
            <i class="mdi mdi-content-paste title_icon"></i>
            <span class="ms-2"><?php echo get_phrase('department'); ?></span>
          </h4>
          <p class="inspiring-line mt-2">
            Uniting expertise to foster growth and innovation.
          </p>
        </div>
        <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1"
          onclick="rightModal('<?php echo site_url('modal/popup/department/create'); ?>', '<?php echo get_phrase('create_department'); ?>')">
          <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_department'); ?>
        </button>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
