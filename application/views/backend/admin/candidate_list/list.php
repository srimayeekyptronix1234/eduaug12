            ...
            foreach ($candidateList as $list) {
                ...
                <tr>
                    <td><img class="rounded-circle" width="50" height="50"
                            src="<?php echo $this->user_model->get_candidate_image($list['id']); ?>"></td>
                    ...
                    <td>
                        <div class="dropdown text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="<?php echo site_url('uploads/candidate/resume/' . $list['resume']); ?>" target="_blank"
                                    class="dropdown-item"><?php echo get_phrase('download_resume'); ?></a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item"
                                    onclick="rightModal('<?php echo site_url('modal/popup/candidate_list/edit/' . $list['id']); ?>', '<?php echo get_phrase('update_candidate'); ?>')"><?php echo get_phrase('edit'); ?></a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item"
