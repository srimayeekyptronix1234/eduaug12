						...
						<div class="dropdown text-center">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="rightModal('<?php echo site_url('modal/popup/class_room/edit/' . $class_room['id']) ?>', '<?php echo get_phrase('update_class_room'); ?>');"><?php echo get_phrase('edit'); ?></a>
								<!-- item-->
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="confirmModal('<?php echo route('class_room/delete/' . $class_room['id']); ?>', showAllClassRooms)"><?php echo get_phrase('delete'); ?></a>
							</div>
						</div>
					</td>
				</tr>
