						...
						<div class="dropdown text-center">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="rightModal('<?php echo site_url('modal/popup/grade/edit/' . $grade['id']) ?>', '<?php echo get_phrase('update_grade'); ?>');"><?php echo get_phrase('edit'); ?></a>
								<!-- item-->
								<a href="javascript:void(0);" class="dropdown-item"
									onclick="confirmModal('<?php echo route('grade/delete/' . $grade['id']); ?>', showAllGrades )"><?php echo get_phrase('delete'); ?></a>
							</div>
						</div>
					</td>
				</tr>
