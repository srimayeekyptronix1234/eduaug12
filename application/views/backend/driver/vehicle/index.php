        ...
        <div>
          <h4 class="page-title mb-0 d-flex align-items-center">
            ...
            <span
              ...
              <?php echo get_phrase('vehicle'); ?>
            </span>
          </h4>
          <p class="text-muted mt-2" style="font-size: 16px; font-weight: 600; color: #000 !important;">
            Manage vehicle details and add new vehicles as needed.
          </p>
        </div>
        <!--
                <div>
                    <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1" onclick="rightModal('<?php echo site_url('modal/popup/vehicle/create'); ?>', '<?php echo get_phrase('add_vehicle'); ?>')">
                        <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_Vehicle'); ?>
                    </button>
                </div>
                -->
      </div> <!-- end card body-->
