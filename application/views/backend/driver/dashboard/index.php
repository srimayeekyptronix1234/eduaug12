            ...
            <div class="card widget-flat" id="teacher" style="on">
              <div class="card-body">
                ...
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Teacher"> <i
                    class="mdi mdi-account-group title_icon"></i><?php echo get_phrase('teacher'); ?> <a
          ...
          <div class="col-lg-4">
            <div class="card widget-flat" id="route" style="on">
              <div class="card-body">
                ...
                ?>
                <h5 class="text-muted font-weight-normal mt-0" title="Route"> <i
                    class="mdi mdi-routes title_icon"></i><?php echo get_phrase('route'); ?>
                  <?php if (count($check_data) > 0) {
                    echo '(' . count($check_data) . ')';
                  } ?>
                  <a href="<?php echo route('route'); ?>" style="color: #6c757d; display: none;" id="route_list"><i
