  ...
  <div class="col-12">
    <div class="card">
      <div class="row mt-3 d-print-none">
        ...
        <div class="col-md-2 mb-1">
          <select name="class" id="class_id" class="form-control select2" data-bs-toggle="select2" onchange="classWiseSectionTeacherLogin(this.value,'<?=$teacher_table_data['section_id']?>')" required>
