    ...
    <div class="card">
      <div class="card-body py-2">
        <h4 class="page-title d-inline-block">
          <i class="mdi mdi-format-list-numbered title_icon"></i> <?php echo get_phrase('manage_project_marks'); ?>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
    ...
    <div class="col-12">
        <div class="card">
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    <button class="btn btn-block btn-secondary" onclick="filter_project_marks()" ><?php echo get_phrase('filter'); ?></button>
                </div>
            </div>
