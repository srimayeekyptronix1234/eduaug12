        ...
        <div class="row">
            ...
            <div class="card widget-flat" id="student" style="on">
              <div class="card-body">
                ...
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Student"> <i
                    class="mdi mdi-account-group title_icon"></i> <?php echo get_phrase('students'); ?> <a
                    href="<?php echo route('student'); ?>" style="color: #6c757d; display: none;" id="student_list"><i
          ...
          <div class="col-lg-4">
            <div class="card widget-flat" id="complaints" style="on">
              <div class="card-body">
                ...
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Complaints"> <i
                    class="mdi mdi-file-compare title_icon"></i><?php echo get_phrase('complaints'); ?> <a
                    href="<?php echo route('complaints'); ?>" style="color: #6c757d; display: none;" id="parent_list"><i
                      class="mdi mdi-export"></i></a></h5>
                <h4 class="mt-3 mb-3">
                  <?php
          ...
          <div class="col-xl-4">
            ...
            if (isset($teacher_permissions_data['online_exam']) && $teacher_permissions_data['online_exam'] == '1') {
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="text-muted font-weight-normal mt-0" title="Exam Schedule"> <i
                      class="mdi mdi-book-clock title_icon"></i> <?php echo get_phrase('Exam Schedule'); ?> <a
                      href="<?php echo route('exam'); ?>" style="color: #6c757d; display: none;" id="exam_list"><i
                        class="mdi mdi-export"></i></a></h5>
                  <h3 class="mt-3 mb-3">
                    <?php
                    $this->db->select('oed.*');
