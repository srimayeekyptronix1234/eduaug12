...
if (!empty($class_id) && !empty($section_id)) {
  $check_data = $this->db->get_where('semester_plan', array('class_id' => $class_id, 'section_id' => $section_id,'teacher_id'=> $user_id))->result_array();

} else {
  $check_data = $this->db->get_where('semester_plan',['teacher_id' => $user_id])->result_array();
}
