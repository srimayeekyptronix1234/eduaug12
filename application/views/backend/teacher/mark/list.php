<div class="row mb-3">
  ...
  <div class="col-md-4 toll-free-box text-center text-white pb-2"
    style="background: linear-gradient(195deg, #ff00c3, #d123ba, #a42dab, #7b2f97, #552b80, #342465, #181a48, #050b2b); border-radius: 10px;">
...
<?php if ($check_permission): ?>
  <?php if (count($marks) > 0): ?>
    <table class="table table-bordered table-responsive-sm"
      style="border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);" width="100% padding: 30px;">
      ...
      <tbody>
        <?php foreach ($marks as $mark):
          ...
          <tr>
            ...
            <td>
              <input class="form-control" type="text" id="comment-<?php echo $mark['student_id']; ?>" name="comment"
                placeholder="comment" value="<?php echo $mark['comment']; ?>">
            </td>
            <td class="text-center">
              <button class="btn btn-success" onclick="mark_update('<?php echo $mark['student_id']; ?>')">
