            ...
            <div class="card-body py-2">
                ...
                <?php if (isset($check_permission) && $check_permission == '1') { ?>
                    <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-end mt-1"
                        onclick="rightModal('<?php echo site_url('modal/popup/assignment/create'); ?>', '<?php echo get_phrase('create_assignment'); ?>')">
                        <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_assignment'); ?></button>
                <?php } ?>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    <button class="btn btn-block btn-secondary"
                        onclick="filter_assignment()"><?php echo get_phrase('filter'); ?></button>
                </div>
            </div>
