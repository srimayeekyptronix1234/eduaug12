    ...
    <tbody>
        ...
        foreach ($enrols as $enroll) {
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-icon btn-secondary btn-sm btn-dark" style="margin-right:5px;"
                        ...
                        data-original-title="<?php echo get_phrase('student_profile'); ?>"> <i
                            class="dripicons-checklist"></i></button>

                    <a href="<?php echo route('student/edit/' . $student['id']); ?>"
                        class="btn btn-icon btn-secondary btn-sm btn-dark" style="margin-right:5px;"
                        data-bs-toggle="tooltip" data-bs-placement="top" title=""
                        data-original-title="<?php echo get_phrase('update_student_information'); ?>"> <i
                            class="mdi mdi-wrench"></i></a>

                    <button id="uname" type="button" class="btn btn-icon btn-secondary btn-sm tooltip_togle"
                        style="margin-right:5px;"
                        onclick="confirmModal('<?php echo route('student/delete/' . $student['id'] . '/' . $student['user_id']); ?>', showAllStudents)"
                        data-bs-toggle="tooltip" data-bs-placement="top" title=""
                        data-original-title="<?php echo get_phrase('delete_student'); ?>"> <i
