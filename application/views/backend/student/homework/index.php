...
$school_id = school_id();
$marks = $this->db->get_where('homework', ['student_id' => $student_details['id'], 'class_id' => $get_student_data['class_id']])->result_array();
?>
<!--title-->
<div class="row">
  <div class="col-xl-12">
        ...
        <div>
          <h4 class="page-title mb-0 d-flex align-items-center">
            ...
            <span
              ...
              <?php echo get_phrase('manage_homework_marks'); ?>
            </span>
          </h4>
          <p class="text-muted mt-2" style="font-size: 16px; font-weight: 600; color: #2c2c2c !important;">
            Track and evaluate student homework assignments effectively.
          </p>
        </div>
      </div> <!-- end card body-->
    </div> <!-- end card -->
