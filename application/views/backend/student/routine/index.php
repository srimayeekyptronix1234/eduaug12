<style>
	...
	button.btn.btn-block.boxbtn {
		background: #0272F3;
		color: #fff;
	}

	button.btn.btn-block.boxbtn:hover {
		background: #000;
		color: #fff;
	}
</style>
...
<div class="row">
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body d-flex align-items-center justify-content-between adminbar py-4">
				<div>
					...
					<p class="text-muted mt-2" style="font-size: 16px; font-weight: 600; color: #2c2c2c !important;">
						Plan your day effectively with the class routine overview.
					</p>
				</div>
			</div> <!-- end card body-->
		</div> <!-- end card -->
