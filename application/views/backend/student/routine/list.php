...
<!-- Bootstrap JS (includes Popper.js for tooltip) -->
                            ...
                            <div class="btn-group text-start">
                                <button type="button" class="btn btn-custom" data-toggle="modal"
                                    ...
                                    <p style="margin-bottom: 0;">
                                        <i class="mdi mdi-book-open-variant"></i> <?php echo $subject_name; ?>
                                    </p>
                                    <p style="margin-bottom: 0;">
                                        <i class="mdi mdi-clock"></i> <?php echo $time_range; ?>
                                    </p>
                                </button>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="<?php echo $modal_id; ?>Label"><?php echo $subject_name; ?>
                                                Details</h5>
