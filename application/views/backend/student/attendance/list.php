    ...
    <div class="card bg-secondary text-white">
      <div class="card-body popbox">
        <div class="text-center">
          <h4>
            <?php echo get_phrase('attendance_report') . ' ' . get_phrase('of') . ' ' . date('F', $attendance_date); ?>
          </h4>
...
<table
  class="table table-bordered table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table-sm">
  <thead class="thead-dark">
    <tr style="font-size: 8px;">
      <th width="100%" style="font-size: 8px;"><?php echo get_phrase('student'); ?> <i class="mdi mdi-arrow-down"></i>
      ...
      for ($i = 1; $i <= $number_of_days; $i++): ?>
        <th style="font-size: 10px;"><?php echo $i; ?></th>
      <?php endfor; ?>
    </tr>
  </thead>
  <tbody>
