<?php
$date_from = strtotime(date('m/01/Y') . " 00:00:00"); // hard-coded '01' for the first day
$date_to = strtotime(date('m/t/Y') . " 23:59:59");
?>
<div style="overflow-y: auto; max-height: 171px;">
                ...
                <?php if (strtotime($event['starting_date']) >= $date_from && strtotime($event['starting_date']) <= $date_to): ?>
                    <div class="timeline-item">
                        ...
                        <div class="timeline-item-info">
                            <a href="#"
                                class="text-info font-weight-bold mb-1 d-block"><?php echo htmlspecialchars($event['title']); ?></a>
                            <p style="font-size: 12px;">
                                <?php echo date('D, d-M-Y', strtotime($event['starting_date'])); ?> -
